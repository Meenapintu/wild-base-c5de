...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wild-base-c5de
```

A live public deployment of this template is available at [https://wild-base-c5de.templates.workers.dev](https://wild-base-c5de.templates.workers.dev)
